...
public class CreateCustomerPostCreateCustomerSoapToJsonTest {
	...
	public void testInputJsonToSoapPayload() throws TestException {
		...
		try {
			String inputResourcePath = "/postCreatecustomer_toJSON_input_data.xml";
		...
		try {
			...
			String expectedResourcePath = "/postCreatecustomer_toJSON_output_data.json";
			InputStream resourceStream = Thread.currentThread().getContextClassLoader()
